...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/90jr6k546tdu1-PK/image;s=300x600;q=60"/>

<Grid item xs={12} sm={8} md={4}> 



<Details   data="‎ Beautiful Customised Forces Mobile Covers with your Name Printed on it. Please, Come in inbox for more details, queries & orders  "  work=" Residential Plots " 
 Make="Condition
 " situation="Type
 " Apple=" New  "   Inuse=" Mobile "  />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard price="900" name=" Back cover pouch for iphone 6plus/6s" Time="Today"   />
      < Map locate="Baffer Zone 2 karachi "/>
      < AdsCard/>
      </Grid> 
