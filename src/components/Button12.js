...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/uimua16ylbw13-PK/image;s=300x600;q=60"/>

<Grid item xs={12} sm={8} md={4}> 


<Details   data="Them The Best Deal."  work="Pakistan's First International Theme Park " 
 quality="Bahria Homes "  More= "" condition="Bahria Quaid And Iqbal Villas" color="World 3th & Pakistan Biggest Masque"
 Make="Type" situation=" Area " Apple=" Residential Plots   "   Inuse="500" 
 Main="International Standard Schools & Hospital" Important="Commercial Areas " Most="Mini Golf Course  " End="  Food Court "
 Traits="Gold Class Cinema " Design="4 Start Grand Hotel Inside Bahria Town " Area="Parks & Playing Areas  " AboutBanks=" Horse Riding And Football Club  "
 PrimeLocation ="Prime Location.Reasonable Price.  " Difference="Difference Is Only One Call " Parks= "Parks & Playing Areas  " Cricket="Cricket Academy & Cricket Stadium " />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard  price="6000,000" name="500 Sq.Yards Residential pilot At Jinnah" Time="Today" />
      < Map locate="Bahria town karachi"/>
      < AdsCard/>
      </Grid> 
