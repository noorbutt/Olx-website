...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/3xd8knmisfko2-PK/image;s=300x600;q=60 "/>
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard   price="210,000"  name=" Suzuki Mega Carry 2020 On Easy Installment" Time="3 Days ago" />
      < Map locate="Gulistan-e-Jauhar Block 19, Karachi, Sindh"  />
      < AdsCard/>
      </Grid> 
