...
<img  className="cardimage1"  src=" https://apollo-singapore.akamaized.net/v1/files/hp9ppgi900mm2-PK/image;s=300x600;q=60 "/>

<Grid item xs={12} sm={8} md={4}> 
{/* <CardsDetails/> */}


<Details   data="7 plus pta approved 256gb" work="Factory unlocked "
 quality="Touch id ok"  More= "All working frsh kit " condition="Condition can be seen in pics " color="Colour Silver "
 Make="Make" situation="Condition" Apple="Apple" Inuse="Used" />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard price="15,500"  name="Samsung Note 5"  Time="3 Days ago"    />
      < Map locate="Mehmodabad karachi"   />
      < AdsCard/>
      </Grid> 
