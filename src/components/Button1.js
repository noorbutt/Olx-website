...
//color="inherit"
  ...
  return (
     ...
     <img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/uquu24f61c231-PK/image;s=300x600;q=60"/>
     ...
     <CardsDetails/>
      ...
      <Grid item xs={12} sm={8} md={4}> 
      <MiniCard   price="3,50,000"  name=" Suzuki Mega Carry 2020 On Easy Installment" Time="Yesterday"  />
      < Map  locate="Gulshan-E-Iqbal Block 13, Karachi, Sindh" />
      < AdsCard/>
      </Grid> 
