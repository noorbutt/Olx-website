...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/wzto95gi0ooc1-PK/image;s=300x600;q=60  "/>
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard    price="2,60,000"  name="Suzuki Mega Carry 2020 On Easy Installment" Time="Today" />
      < Map locate="Gulistan-e-Jauhar Block 10, Karachi, Sindh" />
      < AdsCard/>
