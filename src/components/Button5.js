...
<img  className="cardimage1"  src=" https://apollo-singapore.akamaized.net/v1/files/qcujllaz2j062-PK/image;s=300x600;q=60  "/>

<Grid item xs={12} sm={8} md={4}> 
{/* <CardsDetails    /> */}

<Details   data="SEIKO Men's CHRONOGRAPH Hand Watch " work="Black Leather Strap "
 quality="10 Bar Water Resistant Distance"  More= "Hardlex Glass " condition="Japanese Industry -1 Year International Warranty"
  color="SEIKO Men's Hand Watch CHRONOGRAPH Black Leather Strap, Black Dial and 100m Water Resistant SKS485P1 "
  Make="Condition" situation="Type " Apple="New" Inuse="2019"  />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard  price="18,399" name="Amazfit T-Rex (Black Rock-khaki)" Time="Yesterday"  />
      < Map  locate="Sadar karachi"/>
      < AdsCard/>
      </Grid> 
