...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/krez61q58dt12-PK/image;s=300x600;q=60"/>

<Grid item xs={12} sm={8} md={4}> 



<Details   data="iPhone 7 plus "  work="128gb"
 quality="10/10"  More= "Pta approved " condition="Factory unlocked " color="Fixed price final price"
 Make="Condition " situation="Type" Apple="Apple"   Inuse="New "  />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard  price="79,999" name=" IPhone 8 lpus 10.10 pta approved CNIC" Time="oct 08"/>
      < Map  locate="DHA phase karachi " />
      < AdsCard/>
      </Grid> 
