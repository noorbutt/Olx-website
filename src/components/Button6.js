...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/24pblg3qnlwd-PK/image;s=300x600;q=60  "/>

<Grid item xs={12} sm={8} md={4}> 


<Details   data="I want sell my VIP heavy bike "  work="Bike me koi kam nahi he "
 quality="Dual slender "  More= "All working frsh kit " condition="Mint coundtion " color="375000 se kem wale rabta na karen  " 
 Make="Make" situation="year " Apple=" Kawasaki "   Inuse="2019"   />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard price="190,000"  name="Kawasaki ninja 300 Cc replica " Time="Today" />
