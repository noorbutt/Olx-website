...
<img  className="cardimage1"  src="https://apollo-singapore.akamaized.net/v1/files/x5ylok9sa6f7-PK/image;s=300x600;q=60"/>
...
<Details   data="swiss gear  "  work="travel bag"
 quality="15 to 20 kg capacity "  More= "nylon + water n scratch proof fabric" condition="2 year fabric gurantee" color="Black"
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard  price="2,000" name="nikon dslr bag travel"  Time="oct 12" />
      < Map locate="phecs Karachi" />
      < AdsCard/>
      </Grid> 
