...
<img  className="cardimage1"  src="  https://apollo-singapore.akamaized.net/v1/files/q1p4sut545ve-PK/image;s=300x600;q=60 "/>

<Grid item xs={12} sm={8} md={4}> 


<Details   data="Product Details: "  work="100% Brand New Original and High Quality. "
 quality="Stylish, wearable design.  "  More= "Lightweight and comfortable. " condition="Stereo Sound.  " color="Color: White  "
 Make="Condition " situation="Type" Apple="New "   Inuse="Mobile "  />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard price="300" name=" goiness original handfrees available" Time="Today" />
      < Map locate="karachi administration" />
      < AdsCard/>
      </Grid> 
