...
<img  className="cardimage1"  src=" https://apollo-singapore.akamaized.net/v1/files/gcfmsesqqyah3-PK/image;s=300x600;q=60   "/>

<Grid item xs={12} sm={8} md={4}> 


<Details   data="‎پلیز مکلمل معلومات پڑھے"  work="Vibrate Your hand on morning Alarm  "
 quality=" Raise Your Hand To Turn Screen On"  More= "Battery Timing 20 hrs to 72hrs depend on usage" condition="Battery Timing 20 hrs to 72hrs depend on usage" color="TFT Color Touch Display "
 Make="Condition " situation="Type" Apple="New "   Inuse=" Watches for Men "  />
...
<Grid item xs={12} sm={8} md={4}> 
      <MiniCard  price="1,300" name=" flipro Smart Watch 2020 Heigh Demand" Time="Today" />
      < Map locate="karachi sindh " />
      < AdsCard/>
      </Grid> 
